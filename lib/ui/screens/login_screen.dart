...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget _bodyView(BuildContext context) {
    return lwaAuth.isLoggedIn ? _loggedInWidgets() : _loggedOutWidgets(context);
  }
                                                                    ...
                                                                    _isLoading ==
                                                                        ...
                                                                        : signInWithGoogle()
                                                                            ...
                                                                            if (result !=
                                                                              ...
                                                                              goToDialog();
                                                                              socialLogin("google", email, password, code, name, "uid");
                                                                            }
                                                                          });
                                                                  }),
                                                        )),
