    ...
    return Scaffold(
      ...
      body: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            //  getGenreData().;
            // List videoList = List.generate(
            //     genreDataList == null ? 0 : genreDataList.length, (index) {
            //   // print("type: ${genreDataList[index].type}");
            //   if (widget.type == genreDataList[index].type) {
            //     return 1;
            //   } else {
            //     return null;
            //   }
