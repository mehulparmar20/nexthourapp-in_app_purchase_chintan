...
class AppModel {
  ...
  Config? config;
  List<Plan>? plans;
  List<PlansFeature>? plansFeature;
  List<Block>? blocks;
  Adsense? adsense;
  AppConfig? appConfig;
  List<Blog>? blogs;
  ...
  factory AppModel.fromJson(Map<String, dynamic> json) => AppModel(
        ...
        plansFeature: List<PlansFeature>.from(
            json["plans_feature"].map((x) => PlansFeature.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "plans_feature": List<dynamic>.from(plans!.map((x) => x.toJson())),
