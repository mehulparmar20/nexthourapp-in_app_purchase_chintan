...
//   @override
//   _StripeTestState createState() => new _StripeTestState();
// }
...
//         publishableKey: "pk_test_YCf3dnKIK6iXTJyFEWtb0aml",
//         merchantId: "Test",
//         androidPayMode: 'test'));
//   }
...
//                     .then((paymentMethod) {
//                   print(
//                       "Receivedpayment123 card-id: ${paymentMethod.card!.cardId}");
//                   // print(
//                   // "Receivedpayment123 card: ${paymentMethod.card!}");
//                   print(
//                       "Receivedpayment123 billingDetails: ${paymentMethod.billingDetails!.email}");
//                   print("Receivedpayment123 created: ${paymentMethod.created}");
//                   print(
//                       "Receivedpayment123 customerId: ${paymentMethod.customerId}");
//                   print("Receivedpayment123 id: ${paymentMethod.id}");
//                   print(
//                       "Receivedpayment123 livemode: ${paymentMethod.livemode}");
//                   print("Receivedpayment123 type: ${paymentMethod.type}");
//                   _scaffoldKey.currentState!.showSnackBar(
